...
repoPath = "$HOME/Documents/Git/Reactor-for-Assimilate/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-Assimilate/-/archive/main/Reactor-for-Assimilate-main.zip?path=Atoms/"

"""
Assimilate Atom to JSON.py - v4.0 2025-11-07
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "Assimilate Atom to JSON" Fusion comp script generates (.json) documents from Assimilate based Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > Assimilate Atom to JSON" menu item. The Console window displays the atoms package conversion process.
