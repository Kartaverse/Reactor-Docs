...
repoPath = "$HOME/Documents/Git/Reactor-for-Nuke/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-Nuke/-/archive/main/Reactor-for-Nuke-main.zip?path=Atoms/"

"""
Nuke Atom to JSON.py - 2025-11-10 02.32 PM
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "Nuke Atom to JSON" Fusion comp script generates (.json) documents from Nuke based Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > Nuke Atom to JSON" menu item. The Console window displays the atoms package conversion process.
