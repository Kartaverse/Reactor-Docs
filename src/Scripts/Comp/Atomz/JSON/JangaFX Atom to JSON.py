...
repoPath = "$HOME/Documents/Git/Reactor-for-JangaFX/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-JangaFX/-/archive/main/Reactor-for-JangaFX-main.zip?path=Atoms/"

"""
JangaFX Atom to JSON.py - v4.0 2025-10-29 02.59 PM
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "JangaFX Atom to JSON" Fusion comp script generates (.json) documents from JangaFX based Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > JangaFX Atom to JSON" menu item. The Console window displays the atoms package conversion process.
