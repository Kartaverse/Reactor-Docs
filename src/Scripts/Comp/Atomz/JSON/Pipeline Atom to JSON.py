...
repoPath = "$HOME/Documents/Git/Reactor-for-Pipelines/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-Pipelines/-/archive/main/Reactor-for-Pipelines-main.zip?path=Atoms/"

"""
Pipeline Atom to JSON.py - v4.0 2025-11-05 12.42 PM
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "Pipeline Atom to JSON" Fusion comp script generates (.json) documents from Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > Pipeline Atom to JSON" menu item. The Console window displays the atoms package conversion process.
