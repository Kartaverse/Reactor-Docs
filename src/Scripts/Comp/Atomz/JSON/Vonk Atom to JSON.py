...
repoPath = "$HOME/Documents/Git/Vonk/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/AndrewHazelden/Vonk/-/archive/master/Vonk-master.zip?path=Atoms/"

"""
Vonk Atom to JSON.py - v4.0 2025-10-29 02.59 PM
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "Vonk Atom to JSON" Fusion comp script generates (.json) documents from Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > Vonk Atom to JSON" menu item. The Console window displays the atoms package conversion process.
