...
repoPath = "$HOME/Documents/Git/Reactor-for-TVPaint/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-TVPaint/-/archive/main/Reactor-for-TVPaint-main.zip?path=Atoms/"

"""
TVPaint Atom to JSON.py - v4.0 2026-05-02 04.13 PM
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "TVPaint Atom to JSON" Fusion comp script generates (.json) documents from Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > TVPaint Atom to JSON" menu item. The Console window displays the atoms package conversion process.
