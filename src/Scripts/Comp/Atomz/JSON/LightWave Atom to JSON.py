...
repoPath = "$HOME/Documents/Git/Reactor-for-LightWave/"

# Zip Package Download URL
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-LightWave/-/archive/main/Reactor-for-LightWave-main.zip?path=Atoms/"

"""
LightWave Atom to JSON.py - v4.0 2025-10-29 02.59 PM
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "LightWave Atom to JSON" Fusion comp script generates (.json) documents from LightWave based Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > LightWave Atom to JSON" menu item. The Console window displays the atoms package conversion process.
