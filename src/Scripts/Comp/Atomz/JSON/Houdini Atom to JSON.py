...
repoPath = "$HOME/Documents/Git/Reactor-for-Houdini/"

# Zip Package Download URL
# ZipFile = "https://gitlab.com/AndrewHazelden/Vonk/-/archive/master/Vonk-master.zip?path=Atoms/"
ZipFile = "https://gitlab.com/WeSuckLess/Reactor-for-Houdini/-/archive/main/Reactor-for-Houdini-main.zip?path=Atoms/"

"""
Houdini Atom to JSON.py - v4.0 2025-10-09
By Andrew Hazelden <andrew@andrewhazelden.com>

Overview
---------
The "Houdini Atom to JSON" Fusion comp script generates (.json) documents from Houdini based Reactor Package Manager "atom" package descriptions. This allows external tools to work with atoms.
...
Script Usage
------------
Step 1. Open the "Script > Atomz > Houdini Atom to JSON" menu item. The Console window displays the atoms package conversion process.
